...
/*
  ...
  |
 */
$config['base_url'] = 'http://localhost/krosyl_pharam/';
...
if (!defined('ADMIN_IMAGE_URL'))
    define('ADMIN_IMAGE_URL', $config['base_url'] . 'assets/admin_assets/images/');
...
/*
  ...
  |
 */
$config['encryption_key'] = '!!##JIHS_RANA_SOYAB##!!';
