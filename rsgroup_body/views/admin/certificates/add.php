...
<div class="col-md-12">
    ...
    <form action="<?php echo ADMIN_URL . 'certificate/add' ?>" method="post" id="add" class="form-horizontal" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="certificatetitle" class="form-control required" placeholder="certificate Title"/>
            </div>
        </div>
